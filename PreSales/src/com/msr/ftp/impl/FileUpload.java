...
public class FileUpload {
    ...
    public static void main(String[] args) {
        try {
            String filePath = "disk1/Backup/Temp/ILC_Application_Description_Document_Ver_1.0.pdf";
            //new FileUpload().upload("192.168.1.122", null, null, "disk1/Backup/Temp/temp.pdf", new File("/root/Desktop/ILC Application Description Document_Ver_1.0.pdf"));
            //boolean issuccess = new FileUpload().download("192.168.1.122", null, null, filePath, new File("/root/Desktop/Temp.pdf"));
