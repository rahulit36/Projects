...
public class AccordionMenu extends javax.swing.JPanel {
 ...
 JTabbedPane tabbedPane = null;
     ...
     * @param email
     */
    public AccordionMenu(String menuDescriptor, MainScreen accPanel, JPanel trackingPanel, String email,  JTabbedPane tabbedPane) {
        this();
    ...
    private AccordionRootItem createRootItem(String title, String name, MainScreen tempAccPanel) {
        AccordionRootItem menu = new AccordionRootItem(title, tempAccPanel, trackingPanel, email,  tabbedPane);
        menu.setName(name);
        add(menu);
        return menu;
    }
