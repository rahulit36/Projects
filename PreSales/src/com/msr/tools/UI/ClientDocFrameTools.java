 ...
 * @version V1.0
 */
public class ClientDocFrameTools extends javax.swing.JFrame {
...
List<String> benList = null;
    ...
    List<DocumentsDetailBean> docButtonList = null;
   /**
     ...
     * @param newTxPanel 
     */
    public ClientDocFrameTools(String email, String clientName) {
        this.email= email;
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(viewListButton, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(addFileButton, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(addDirectoryButton, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//             if(!tp.getLastPathComponent().toString().contains(".xls")&&!tp.getLastPathComponent().toString().contains(".doc")&&!tp.getLastPathComponent().toString().contains(".pdf")){
            GetDocUploadFrameTools upFrame = new GetDocUploadFrameTools(this, clientName, email, tempPath, docMap, tp, (MutableTreeNode)tp.getLastPathComponent(),benList);
...
//                 if(tempNode.toString().contains(".xls")||tempNode.toString().contains(".pdf")||tempNode.toString().contains(".doc")){
    ...
    private void viewListButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewListButtonActionPerformed
            DocListOnButtonClickFrame dlobcf =new  DocListOnButtonClickFrame(docButtonList);
            dlobcf.setVisible(true);;
...
//     this will create initial tree structure....................
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientDocFrameTools.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ClientDocFrameTools("satyendra.s@msronline.in", "KLM Airlines").setVisible(true);
