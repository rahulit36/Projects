...
public class QueryReportExcel {

	private String inputFile = null;
	XSSFWorkbook hwb = null;
    XSSFSheet sheet = null;
    String fileName = null;
	List<QueryDetailBean> meetingList = null;
	
	
	public QueryReportExcel(String input,  List<QueryDetailBean> meetingList) {
...
//		  fileName = "/home/Reports/GeneratedRepots/FlC Daily Report.xlsx";
		  ...
		  hwb = new XSSFWorkbook();
	        sheet = hwb.createSheet("Query Details");
...
//	        Meeting Report from January 2012
	        ...
	        cell6h.setCellValue("Query Report");
                    ...
                    for(String mnth :month){
                      ...
                      boolean isRecordExist=false;  
                        ...
                        Iterator itr2 = queryList.iterator();
                         while(itr2.hasNext()){
                             QueryDetailBean meetingBean = (QueryDetailBean)itr2.next();
                             String dateStr = meetingBean.getRaiseDate();
                    try {
                        ...
                        cell2.setCellValue(meetingBean.getRmName());
                        cell2.setCellStyle(dataStyle);
                        XSSFCell cell3 = row.createCell((short)3);
                        cell3.setCellValue(meetingBean.getClientName());
                        cell3.setCellStyle(dataStyle);
                        XSSFCell cell4 = row.createCell((short)4);
                        cell4.setCellValue(meetingBean.getBankName());
                        cell4.setCellStyle(dataStyle);
                        XSSFCell cell5 = row.createCell((short)5);
                        cell5.setCellValue(meetingBean.getRaiseDate());
                        cell5.setCellStyle(dataStyle);
                        XSSFCell cell6 = row.createCell((short)6);
                        cell6.setCellValue(meetingBean.getQueryDetails());
                        cell6.setCellStyle(dataStyle);
                        XSSFCell cell7 = row.createCell((short)7);
                        cell7.setCellValue(meetingBean.getQueryStatus());
                        cell7.setCellStyle(dataStyle);
                        XSSFCell cell8 = row.createCell((short)8);
                        cell8.setCellValue(meetingBean.getCloseDate());
